...
export default async function OnboardingPage() {
  ...
  // First-time setup only — permanently closed after completion.
  ...
  return (
    <main className="min-h-screen bg-[#eef1f6] px-4 py-10 sm:px-8 sm:py-14">
      <div className="mx-auto mb-9 max-w-5xl text-center">
        ...
        <h1 className="mt-2 text-3xl font-extrabold tracking-[-0.06em] text-[#111a32] sm:text-4xl">
          Build your first customer flow
        </h1>
        <p className="mx-auto mt-3 max-w-xl text-sm font-medium leading-6 text-muted-foreground">
          Your progress is saved after each step so you can return whenever you
          need — until you publish your first campaign.
        </p>
      </div>
      <OnboardingWizard
        ownerId={user.id}
