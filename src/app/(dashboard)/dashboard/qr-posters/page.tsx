...
export default async function PosterBuilderIndexPage() {
  ...
  return <PosterBuilderClient campaigns={campaigns.map(({ business, campaign }) => ({ business: { id: business.id, name: business.name, slug: business.slug, logo_url: business.logo_url }, campaign: { id: campaign.id, name: campaign.name, public_token: campaign.public_token } }))} />;
}
