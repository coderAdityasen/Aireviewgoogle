...
const schema = z.object({ planKey: z.enum(["starter", "growth", "pro"]), razorpay_payment_id: z.string().min(1), razorpay_subscription_id: z.string().min(1), razorpay_signature: z.string().min(1) });
