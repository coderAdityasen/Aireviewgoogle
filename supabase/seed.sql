...
values
  ('ai_limits', '{"daily_business_limit": 200, "daily_ip_limit": 20, "max_input_chars": 2200}'::jsonb),
  ('data_retention', '{"visitor_session_days": 90, "feedback_days": 730, "rate_limit_days": 7}'::jsonb),
  ('security', '{"require_email_verification": true, "store_raw_ip": false}'::jsonb),
  (
